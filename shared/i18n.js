(function initOpenFrontHelperI18n(globalScope) {
  ...
  const DEFAULT_TRANSLATIONS = {
    ...
    "Alliance Requests": "Alliance Requests",
    "Show alliance requests panel": "Show alliance requests panel",
    "Pending Requests": "Pending Requests",
    "Active Alliances": "Active Alliances",
    "No alliance requests or active alliances": "No alliance requests or active alliances",
    "Wants to ally with you": "Wants to ally with you",
    ...
    "Renew": "Renew",
    "remaining": "remaining",
    "Close alliance requests panel": "Close alliance requests panel",
    "Resize alliance requests panel": "Resize alliance requests panel",
    "Highlights allies with remaining alliance time.": "Highlights allies with remaining alliance time.",
    "FPS Saver": "FPS Saver",
    "Disables nuke explosion animations to reduce lag.": "Disables nuke explosion animations to reduce lag.",
    "Disables nuke explosion animations.": "Disables nuke explosion animations.",
    "Attack amounts": "Attack amounts",
    "Shows how many troops a player attacks with.": "Shows how many troops a player attacks with.",
    "Cheats": "Cheats",
