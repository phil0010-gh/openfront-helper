(function initOpenFrontHelperI18n(globalScope) {
  ...
  const DEFAULT_TRANSLATIONS = {
    ...
    analyticsSupportTitle: "Share anonymous usage data?",
    ...
    chat: "Chat",
    showExtensionChat: "Show extension chat",
    hideExtensionChat: "Hide extension chat",
    chatSafetyTitle: "Chat safety notice",
    chatSafetyNotice: "Before enabling chat, please keep this in mind:",
    chatSafetyPublic: "Messages can be visible to other OpenFront Helper chat users.",
    chatSafetyBackend: "Messages may be processed and stored by the external chat backend.",
    chatSafetyNoPrivate: "The chat is not intended for private or confidential communication.",
    chatSafetyNoSensitive: "Do not share personal information, passwords, tokens, private lobby details, or anything you would not want others to see.",
    chatSafetyEnable: "I understand, enable chat",
    ...
    anonymous: "Anonymous",
    chatNotConfigured: "Chat is not configured.",
    lobbyChatUnavailable: "Lobby chat is available after a round is detected.",
    "Messages older than 24 hours are automatically deleted.": "Messages older than 24 hours are automatically deleted.",
    chatConnectionFailed: "Chat connection failed.",
    chatSendFailed: "Message could not be sent.",
    "Links are not allowed in chat messages.": "Links are not allowed in chat messages.",
    "You are sending messages too quickly. Please wait a moment.": "You are sending messages too quickly. Please wait a moment.",
    ...
    "Anonymous": "Anonymous",
    "Chat is not configured.": "Chat is not configured.",
    "Lobby chat is available after a round is detected.": "Lobby chat is available after a round is detected.",
    "Chat connection failed.": "Chat connection failed.",
